...
const ProgressiveTotalCompleteAndPending = () => {
  ...
  const totalNoodlesTwoWeek =
    getTotalQuantityOf("noodles", 2) + totalNoodlesThreeWeek;
  const totalNoodlesOneWeek =
    getTotalQuantityOf("noodles", 1) + totalNoodlesTwoWeek;
  const totalNoodlesLatest =
    getTotalQuantityOf("noodles", 0) + totalNoodlesOneWeek;

  const totalVeggiesThreeWeek = getTotalQuantityOf("veggies", 3);
  const totalVeggiesTwoWeek =
    getTotalQuantityOf("veggies", 2) + totalVeggiesThreeWeek;
  const totalVeggiesOneWeek =
    getTotalQuantityOf("veggies", 1) + totalVeggiesTwoWeek;
  const totalVeggiesLatest =
    getTotalQuantityOf("veggies", 0) + totalVeggiesOneWeek;

  const totalCClothesThreeWeek = getTotalQuantityOf("children clothes", 3);
  const totalCClothesTwoWeek =
    getTotalQuantityOf("children clothes", 2) + totalCClothesThreeWeek;
  const totalCClothesOneWeek =
    getTotalQuantityOf("children clothes", 1) + totalCClothesTwoWeek;
  const totalCClothesLatest =
    getTotalQuantityOf("children clothes", 0) + totalCClothesOneWeek;
  ...
  const totalPGearTwoWeek =
    getTotalQuantityOf("protective gear", 2) + totalPGearThreeWeek;
  const totalPGearOneWeek =
    getTotalQuantityOf("protective gear", 1) + totalPGearTwoWeek;
  const totalPGearLatest =
    getTotalQuantityOf("protective gear", 0) + totalPGearOneWeek;

  const totalAClothesThreeWeek = getTotalQuantityOf("adult clothes", 3);
  const totalAClothesTwoWeek =
    getTotalQuantityOf("adult clothes", 2) + totalAClothesThreeWeek;
  const totalAClothesOneWeek =
    getTotalQuantityOf("adult clothes", 1) + totalAClothesTwoWeek;
  const totalAClothesLatest =
    getTotalQuantityOf("adult clothes", 0) + totalAClothesOneWeek;
  ...
  const data = {
    labels: ["Three weeks ago", "Two weeks ago", "One week ago", "Latest"],
    ...
    datasets: [
      ...
      },
      {
        ...
        data: [
          totalCClothesThreeWeek,
          totalCClothesTwoWeek,
          totalCClothesOneWeek,
          totalCClothesLatest,
        ],
      ...
      },
      {
        ...
        data: [
          totalAClothesThreeWeek,
          totalAClothesTwoWeek,
          totalAClothesOneWeek,
          totalAClothesLatest,
        ],
  ...
  const options = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: "Total Delivered Items (progressive)",
      },
    },
  };
  ...
  return (
    <div>
      <div className="header">
        <h1 className="title">Total Delivered Items (progressive)</h1>
      </div>
